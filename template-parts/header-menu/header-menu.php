<!-- Header 1 -->
<nav id="top-transparent-1" class="header-nav-top navbar navbar-expand-lg navbar-light d-none d-lg-block py-0">
    <div class="container">
        <div class="d-flex w-100" id="navbarSupportedContent1">
            <ul class="d-flex w-100 navbar-nav ms-auto align-items-center justify-content-end">
                <?php
                // Получаем адрес
                $address = '';
...
<!-- Menu header -->
<nav id="top-transparent-2" class="d-none d-lg-block header-nav-bottom navbar navbar-expand-lg navbar-dark py-1 py-lg-0">
    <div class="container">
        ...
        <button class="navbar-toggler collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#mobail-header-collapse" aria-controls="mobail-header-collapse" aria-expanded="false" aria-label="Toggle navigation">
...
<header id="sliding-header" class="shadow header-white">
    <!-- Header nav bottom -->
    <nav class="header-nav-bottom navbar navbar-expand-lg navbar-light py-1 py-lg-0">
        <div class="container">
            ...
            <button class="navbar-toggler collapsed" type="button" data-bs-toggle="collapse" data-bs-target="#sliding-header-collapse" aria-controls="sliding-header-collapse" aria-expanded="false" aria-label="Toggle navigation">
                <span class="navbar-toggler-icon"></span>
            </button>
                    ...
                    'items_wrap' => '
                        <ul id="menu-main-menu" class="navbar-nav align-items-lg-center ms-auto mb-2 mb-lg-0 %2$s">%3$s
                            ...
                            <li class="nav-item d-lg-none">
                                ' . (function_exists('mytheme_get_address') && !empty(mytheme_get_address()) ? '
                                <div class="d-flex align-items-center gap-2 mobile-sliding-header-time">
                                    <img src="' . get_template_directory_uri() . '/img/ico/location-ico.svg" alt="" class="mobile-ico" style="width: 12px">
                                    <span class="address-footer">
                                        ' . esc_html(mytheme_get_address()) . '
                                    </span>
                                </div>
                                ...
                                <div class="mobile-sliding-header-time">
                                    <a class="nav-link py-2 d-flex align-items-center gap-2" href="tel:' . esc_attr(mytheme_get_phone_link('main')) . '">
                                        <img src="' . get_template_directory_uri() . '/img/ico/mobile-phone-ico.svg" alt="" class="mobile-ico" style="width: 12px">
                                        <span class="phone-footer">' . esc_html(mytheme_get_phone('main')) . '</span>
                                    </a>
                                </div>
                                ' : '') . '
                                ...
                                ' . (function_exists('mytheme_get_job_time') && !empty(mytheme_get_job_time()) ? '
                                <div class="d-flex align-items-center gap-2 mobile-sliding-header-time">
                                    <img src="' . get_template_directory_uri() . '/img/ico/clock-ico.svg" alt="" class="mobile-ico" style="width: 12px">
                                    <span class="time-footer">
                                        ' . esc_html(mytheme_get_job_time()) . '
                                    </span>
                                </div>
